...
exports.sendRecommendationEmails = void 0;
...
const buildWorkbookBuffer = async (payload) => {
...
const fetchInstitutionContacts = async (fastify, payload) => {
    const app = fastify;
...
const buildEmailHtml = (payload, institution, selectedInstitutionCount) => {
    const fallbackNames = splitCandidateName(payload.candidate.full_name);
...
const sendRecommendationEmails = async (fastify, payload) => {
    const app = fastify;
    if (!app.mailer) {
        app.mailer = (0, mailer_1.createMailer)();
    }
...
exports.sendRecommendationEmails = sendRecommendationEmails;
